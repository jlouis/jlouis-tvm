...
the registers of the language in the constants. Since our system is
also intrinsic, we let a be a family of types:
\begin{verbatim}
cst : tp -> type.
\end{verbatim}
...
For function calls, we took a more traditional approach.
\fixme{Describe how we handle function calls}

\section{Semantics encoding}
\fixme{Describe the semantics encoding}

\section{Typing encoding}
\fixme{Describe how the typing is encoding}
...
\begin{lem}
  ...
  i'$ it implies we have $D;\Psi;\Gamma |- i' : \tau$.\fixme{We do not
    use $\Psi |- BB : \Psi$ yet}
\end{lem}
\begin{proof}
