...
In the semantics, we use the notation $i[x/v]$. This means that you
substitute all occurrences of $x$ with $v$ in the syntax tree of
$i$. In other words, if $(\lambda x . i\; x)$ the higher order
abstraction of $i$ then $i[x/v] \equiv (\lambda x . i\; x) v$. We
