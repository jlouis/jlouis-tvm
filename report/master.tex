...
\newcommand{\ntypesp}{\tau'_1 \times \tau'_2 \times \dotsb \times \tau'_n}
...
Finally the $\icall{r}{f}{(c_1, \dotsc, c_n)}{s}$ instruction
...
\begin{figure}
  ...
  \begin{gather*}
    ...
    \inference[Tp-let]{\Gamma \tpop op : \tau_1 \quad \Phi ; \Psi ;
      ...
      \ilet{x}{op}{s} : \tau}\\\\
    \inference[Tp-do]{\Phi;\cdot;\Gamma |- s_1 : \tau_1 \quad
    ...
    \inference[Tp-letrec]{\Phi;\Psi[bb \mapsto (Bb \tau_1, \dotsc, Bb
      \tau_n)];\Gamma \tpb d_1 : Bb \tau_1\\
      \dotsb \\\Phi;\Psi[bb \mapsto (Bb \tau_1, \dotsc, Bb
      \tau_n)];\Gamma \tpb d_n : Bb\tau_n \\
      \Phi;\Psi[bb \mapsto (Bb \tau_1, \dotsc, Bb
      \tau_n)];\Gamma |- s : \tau}{\Phi;\Psi;\Gamma |- \iletrec{bb}{(d1,
        \dotsc, d_n)}{s} : \tau}\\\\
    \inference[Tp-call]{\Phi(f) = \tau_1 -> \dotsc -> \tau_n -> \tau\\
    c_1 : \tau_1 \quad \dotsb \quad c_n : \tau_n}
  {\Phi;\Psi;\Gamma |- \icall{r}{f}{(c_1, \dotsc, c_n)}{s} : \tau}
  \end{gather*}
  \caption{Typing 2}
...
\fixme{Convert $D <-> \Phi$ from here on out}
